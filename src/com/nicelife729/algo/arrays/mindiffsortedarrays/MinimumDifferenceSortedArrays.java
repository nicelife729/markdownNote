package com.nicelife729.algo.arrays.mindiffsortedarrays;

/**
 * Given two sorted (ascending) com.nicelife729.algo.arrays of integers, where the integers do not repeat and the two com.nicelife729.algo.arrays have no common integers.
 * Let x be any integer in the first array, y any integer in the second. Find min(Abs(x-y)). That is, find the smallest
 * difference between any of the integers in the two com.nicelife729.algo.arrays.
 * <p/>
