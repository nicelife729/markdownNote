package com.nicelife729.algo.strings.checkpalindrome;
 ...
 * Alternate str.equals(new StringBuffer().append(str).reverse().toString()).. reverse and compare 2 com.nicelife729.algo.strings.
 * User: rpanjrath
 * Date: 9/18/13
 * Time: 3:37 PM
 */
