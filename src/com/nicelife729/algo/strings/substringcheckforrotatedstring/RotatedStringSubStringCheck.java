package com.nicelife729.algo.strings.substringcheckforrotatedstring;

/**
 * Given two com.nicelife729.algo.strings, s1 and s2, write code to check if s2 is a rotation of s1 using only one call to isSubstring
