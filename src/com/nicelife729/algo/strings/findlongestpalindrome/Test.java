package com.nicelife729.algo.strings.findlongestpalindrome;
...
public class Test {
    ...
    public static void main(String[] args) {
        String input = "Fourscoreandsevenyearsagoourfaathersbroughtforthonthisconta\n" +
...
////        System.out.println(FindLongestPalindrome.findLongestPalindrome(input));
////        System.out.println(FindTotalNoOfPalindromes.findTotalNoOfPalindromes(input));
//        System.out.println(FindLongestPalindrome.longestPalindromeSimple(input));
