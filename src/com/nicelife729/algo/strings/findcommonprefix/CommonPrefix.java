package com.nicelife729.algo.strings.findcommonprefix;

import java.util.List;

/**
 * Finds common starting string for a list of com.nicelife729.algo.strings. For e.g. aab and aaade have aa in common.
 * Date: 9/13/13
 * Time: 4:31 PM
 */
